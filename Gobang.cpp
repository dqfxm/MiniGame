...
public:
    ...
    {undefined
        ...
        {undefined
            ...
            cout << endl;
            cout << "  ";
            for (size_t i = 1; i < N + 1; ++i){undefined
                cout << "---+";
            }
            cout << endl;
        }
    ...
    void InitChessBoard()
    {undefined
        for (size_t i = 0; i < N + 1; ++i){undefined
            for (size_t j = 0; j < N + 1; ++j){undefined
...
protected:
    ...
    {undefined
        ...
        //检查棋盘是否已满
        for (size_t i = 1; i < N + 1; ++i){undefined
            for (size_t j = 1; j < N + 1; ++j){undefined
